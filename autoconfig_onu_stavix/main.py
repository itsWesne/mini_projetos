...
wan_settings = [
    ...
    [sg.Checkbox('LAN1', default=True, key='lan1'), sg.Checkbox('LAN2', default=True, key='lan2'), sg.Checkbox('LAN3', default=True, key='lan3'), sg.Checkbox('LAN4', default=True, key='lan4')]
]
wifi_settings = [
    ...
    [sg.Text('WIFI 5.8G:', size=(10, 1)), sg.Input(size=(23, 1), key='wifi_5_name'), sg.Push()],
...
admin_settings = [
    ...
    [sg.Text('NEW PASSWORD:', size=(15, 1)), sg.Input(default_text='redefibra2016', size=(18, 1), key='newpass'), sg.Push()]
...
while True:
    ...
    if event == 'CONFIGURAR':
        ...
        oc.login()
        oc.wifi_config(values['wifi_2.4_name'], values['wifi_2.4_pass'], values['wifi_5_name'], values['wifi_5_pass'])
        oc.pon_config(values['vlan'], values['pppoe_user'], values['pppoe_pass'], values['lan1'], values['lan2'], values['lan3'], values['lan4'])
